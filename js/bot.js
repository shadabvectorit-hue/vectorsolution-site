...
(function () {
  ...
  var L = {
    en: {
      ...
      badPhone: "That doesn't look like a complete number — please write the full mobile number (e.g. 0336 3138686).",
    ...
    ur_rm: {
      ...
      badPhone: "Ye number poora nahi lag raha — mehrbani farma kar poora mobile number likhein (misal: 0336 3138686).",
      no: /^(nahi|nahin|no)$/i,
    ...
    ur: {
      ...
      badPhone: "یہ نمبر مکمل نہیں لگ رہا — براہِ کرم پورا موبائل نمبر لکھیں (مثلاً 0336 3138686)۔",
